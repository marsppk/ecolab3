...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
	int16_t (ECOCALLMETHOD *BeginSort)(struct IEcoLab1Events* me, const void* data, size_t size);
    int16_t (ECOCALLMETHOD *IterCreateBuffSort)(struct IEcoLab1Events* me, const void* buff, size_t buff_size, size_t buff_ind, const void* data, size_t data_size, size_t data_ind);
	int16_t (ECOCALLMETHOD *IterWriteResSort)(struct IEcoLab1Events* me, const void* buff, size_t buff_size, size_t buff_ind, const void* data, size_t data_size, size_t data_ind);
	int16_t (ECOCALLMETHOD *FinishSort)(struct IEcoLab1Events* me, const void* data, size_t size);
